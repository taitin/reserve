...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection entry_time
     ...
     * @method Grid\Column|Collection entry_time(string $label = null)
     ...
     * @property Show\Field|Collection entry_time
     ...
     * @method Show\Field|Collection entry_time(string $label = null)
